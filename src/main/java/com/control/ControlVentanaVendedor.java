...
public class ControlVentanaVendedor implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
            ...
            try {
                if (vistaVentanaVendedor.getFieldCodigo().getText().length() == 0
                    ...
                    if (vistaVentanaVendedor.getFieldCodigo().getText().length() == 0) {
                        ...
                        aux = Integer.parseInt(vistaVentanaVendedor.getFieldCodigo().getText());
                    }
                    Product producto = new Product(aux, vistaVentanaVendedor.getFieldNombre().getText());
                    ...
                    if (lista.isEmpty() == false) {
                        ...
                        vistaVentanaVendedor.getFieldCodigo().setText(String.valueOf(lista.get(0).getCode()));
                        vistaVentanaVendedor.getFieldNombre().setText(lista.get(0).getName());
            ...
            try {
                if ((vistaVentanaVendedor.getFieldCodigo().getText().length() == 0
                    ...
                    if (lista.isEmpty() == false) {
                        ...
                        auxiliar = producto.getQuantity();
                        producto.setQuantity(auxiliar - cantidad);
                        lista.get(0).setQuantity(auxiliar);
                        contador++;
                ...
                if (indice == -1) {
                    ...
                    if (respuesta == JOptionPane.YES_OPTION) {
                        Product producto = new Product(
                                Integer.parseInt(
                                        vistaVentanaVendedor.getTablaVentas().getValueAt(indice, 1).toString()),
        ...
        if (vistaVentanaVendedor.getBotonListo() == evento.getSource()) {
            int respuesta;
            respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro de afectuar la venta?", "Confirmación",
    ...
    public void agregarFila(ArrayList<Product> lista, int cantidad) {
        DefaultTableModel modelo = new DefaultTableModel();
        modelo = (DefaultTableModel) this.vistaVentanaVendedor.getTablaVentas().getModel();
        Object[] filas = new Object[6];

        filas[0] = contador;
        filas[1] = lista.get(0).getCode();
        filas[2] = lista.get(0).getName();
        filas[3] = cantidad;
        filas[4] = lista.get(0).getCostOfSale();
        filas[5] = (double) cantidad * lista.get(0).getCostOfSale();
